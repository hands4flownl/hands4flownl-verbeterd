...
<section class="hero">
  <div class="hero-text">
    <span class="hero-eyebrow fade-up">Massage · Reiki · Coaching in Emmen</span>
...
<section class="treatments" id="behandelingen">
  <div class="treatments-header">
    ...
    <p class="section-sub">
      Een unieke combinatie van massages, energetische behandelingen en coaching —
      voor mensen die altijd maar doorgaan en weinig tijd nemen voor zichzelf.
    </p>
  </div>
  ...
  <div class="treatments-grid">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">Diepe ontspanning via de reflexzones in je voeten. Stimuleert het zelfherstellend vermogen, verbetert de doorbloeding en vermindert stress.</p>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">Via handoplegging heft de behandeling blokkades op en versterkt het zelfherstellend vermogen. Ook op afstand mogelijk.</p>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">32 energiepunten op je hoofd worden zacht aangeraakt. Laat beperkende patronen los en ervaar meer rust, helderheid en slaap.</p>
        <a href="{{ '/behandelingen/acces-bars/' | absolute_url }}" class="card-link">Lees meer</a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">Directe verlichting bij spanning in rug, nek en schouders. Over de kleding, laagdrempelig en snel effectief.</p>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">Via gesprekken, ademsessies en lichaamswerk worden blokkades opgeruimd. Kom dichter bij jezelf en leer weer vertrouwen en rust te ervaren.</p>
        <a href="{{ '/coaching/' | absolute_url }}" class="card-link">Lees meer</a>
      </div>
    </div>
...
<section style="background:var(--creme);">
  <div class="about">
    <div class="about-img-wrap">
      <img class="about-img"
           src="https://primary.jwwb.nl/public/z/f/p/temp-umaagwfutijsnqmyiokx/img20260226130755-high.jpg?enable-io=true&enable=upscale&crop=0.5263%3A1%2Coffset-x15&width=700"
    ...
    <div>
      ...
      <p class="section-sub">
        Ik ben Elsemarie van der Ploeg. Naast mijn werk in de gezondheidszorg werk ik met veel liefde
        in mijn praktijk in Emmen. Ik neem de tijd voor jou — met aandacht, zachtheid en vertrouwen.
        Ik kijk verder dan alleen de klacht en stem intuïtief af op wat jij op dat moment nodig hebt.
      </p>
...
<section style="background:var(--oker-xlt);">
  <div style="max-width:1100px;margin:0 auto;text-align:center;">
    ...
    <h2 class="section-title" style="margin-bottom:2rem;">Ervaringen bij hands4flow</h2>

    <div class="reviews-grid">
      <div class="review-card">
        <div class="review-stars">★★★★★</div>
        <p class="review-text">"Ik voelde me meteen thuis en Elsemarie heeft veel te bieden. Ze stelt vragen die niemand anders stelt en kan met haar liefdevolle handen je precies geven wat je nodig hebt."</p>
        <span class="review-author">— Google review</span>
      </div>
      <div class="review-card">
        <div class="review-stars">★★★★★</div>
        ...
        <span class="review-author">— Jeroen, vaste klant</span>
      </div>
      <div class="review-card">
        <div class="review-stars">★★★★★</div>
...
<section style="background:var(--creme-mid);text-align:center;">
  <div style="max-width:600px;margin:0 auto;">
    ...
    <p class="section-sub">Behandelingen vanaf € 35,00. Strippenkaarten en combinaties mogelijk.</p>
...
<section class="contact" id="contact">
  ...
  <div class="contact-info">
    <span><strong>Locatie</strong>Laan van de Marel 551, Emmen</span>
